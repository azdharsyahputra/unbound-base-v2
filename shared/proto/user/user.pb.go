...
func (x *VerifyUserExistsRequest) GetUserId() uint64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
const file_proto_user_user_proto_rawDesc = "" +
	"\n" +
	"\x15proto/user/user.proto\x12\x04user\"2\n" +
	"\x17VerifyUserExistsRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x04R\x06userId\"2\n" +
	"\x18VerifyUserExistsResponse\x12\x16\n" +
	"\x06exists\x18\x01 \x01(\bR\x06exists2`\n" +
	"\vUserService\x12Q\n" +
	"\x10VerifyUserExists\x12\x1d.user.VerifyUserExistsRequest\x1a\x1e.user.VerifyUserExistsResponseB\x13Z\x11proto/user;userpbb\x06proto3"
...
var file_proto_user_user_proto_goTypes = []any{
	(*VerifyUserExistsRequest)(nil),  // 0: user.VerifyUserExistsRequest
	(*VerifyUserExistsResponse)(nil), // 1: user.VerifyUserExistsResponse
}
var file_proto_user_user_proto_depIdxs = []int32{
	0, // 0: user.UserService.VerifyUserExists:input_type -> user.VerifyUserExistsRequest
	1, // 1: user.UserService.VerifyUserExists:output_type -> user.VerifyUserExistsResponse
